export const showTypes = [
  {
    ...
    fullDescription: 'Consists of 6-8 artists on stage that play several instruments like Djembe, Darbouka, Didgeridoo, Congo, Dun Dun Drums, Flute, Drum kit, Brazil drum, tamate, Chande and several side percussion along with cymbals, creating a pure rhythmic aura by playing Indian melody using percussion from all around the world. This creates a fusion of western rhythms and Indian melody leaving the viewers mesmerized.',
    ...
    highlights: ['6-8 artists on stage', 'Fusion of western rhythms and Indian melody', 'Features Djembe, Darbouka, Didgeridoo, Flute and more'],
    gallery: [
